...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGF2aWNpIiwiYSI6ImNrdDRkNmZzODA5N2cyeHBsanIweTczaXAifQ.bD3Z2IUiWR8PHuX-00rYGQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successful login!');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JkQPJAGb2eImRr5jnUHboVB8g0KDfn54732w2RoWzb97xjdryKpkBonD9LzGMZdJ7jIQ6diJJfmEOza34v15AEF00zrmmsEQV');
            _context.prev = 1;
            _context.next = 4;
...
if (bookButton) {
  bookButton.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // tour-id automatically converted to tourId
